...
MAJOR_SCENES = {
    ...
    "lovers": "two adult human lovers facing each other in an enchanted grove, a luminous winged guardian high above them, flowering tree and flame tree, intimate choice and sacred union",
    ...
    "justice": "an armored human judge seated frontally in a marble tribunal, perfectly balanced golden scales in one hand and upright silver sword in the other, red robe, clear gaze",
    "hanged-man": "a human knight suspended upside down by one ankle from a vast living world tree, calm illuminated face, free leg bent into a cross, green-gold halo, misty forest",
    ...
    "devil": "an imposing horned fantasy sovereign with believable humanoid anatomy seated in an obsidian cavern, two adults freeing themselves from loose chains, ember light, temptation and liberation, nonsexual",
